<?php
	...
	if ( !empty($_GET['edit']) && get_pm($_GET['edit']) && get_pm($_GET['edit'])['id_user'] == $user['id_user']
				&& get_pm($_GET['edit'])['pm_type'] == 'Workouts' ) {
		$pm = get_pm($_GET['edit']);
	}
	...
	if ( isset($_POST['submit']) ) {
		...
		if ( empty($_POST['pm_body_1']) ) {
			$alert['content'] = 'Please enter a workout.';
			$alert['type'] = 'error';
		}

		if ( empty($_POST['pm_body_2']) ) {
			//$alert['content'] = 'Please enter the workout routine.';
			//$alert['type'] = 'error';
			$_POST['pm_body_2'] = '';
		}
		...
		if ( !empty($_POST['pm_to_edit']) ) {
			...
			if ( empty($alert['content']) && new_pm ( 'Workouts', '', '', $_POST['pm_body_1'], $_POST['pm_body_2'], $days, $_POST['pm_body_4'], $_POST['pm_body_5']  ) ) {
				$alert['content'] = 'Great! Your workout was added.';
				$alert['type'] = 'success';
			}
			else {
				$alert['content'] = 'Oops! An error occurred, try again.';
        ...
        <div class="content">
            <div class="container-fluid">
                    ...
                    <div class="col-xl-12">
                        <div class="page-title-box">
							...
							?>
								...
								<h4 class="page-title float-left">Edit Workout</h4>
							...
							?>
								...
								<h4 class="page-title float-left">New Workout</h4>
                            ...
                            <ol class="breadcrumb float-right">
                                ...
                                <li class="breadcrumb-item"><a href="/personal-workouts.php">Workouts</a></li>
                        ...
                        <div class="card-box">
                            ...
                            <div class="row">
                                <div class="col-sm-12 col-xs-12 col-md-6">
									...
									?>
										<h4 class="header-title m-t-0">Fill The Form To Add a New Workout</h4>
									<?php
										}
									?>

							<form action="/new-workout.php" data-parsley-validate novalidate method="POST">
                                <div class="p-20">
                                        <div class="form-group">
                                            <div class="form-group">
                                                <label for="userName">Workout Name<span class="text-danger">*</span></label>
												...
												<div class="form-group">
														<label>Select the Days that this Workout is going to be performed<span class="text-danger">*</span></label>
				...
				<div class="form-group">
												...
												<label>Select the Time to Perform the Workout<span class="text-danger">*</span></label>
                                            ...
                                            <div class="form-group">
                                                            <p><label for="userName">Workout Routine and Instructions<span class="text-danger">*</span></label></p>
